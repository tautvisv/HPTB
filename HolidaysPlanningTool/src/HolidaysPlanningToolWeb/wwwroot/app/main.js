...
browser_1.bootstrap(main_app_component_1.MainApp, [ng2_toastr_1.ToastsManager, travel_service_1.TravelService, misc_service_1.MiscService, core_1.provide(ng2_toastr_2.ToastOptions, { useValue: new ng2_toastr_2.ToastOptions(notificationOptions) }), Constants_1.Constants, http_1.HTTP_PROVIDERS]); //
